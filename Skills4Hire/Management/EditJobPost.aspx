<%@ Page Title="Edit Job Post" Language="C#" MasterPageFile="~/Management/Management.Master" AutoEventWireup="true" CodeBehind="EditJobPost.aspx.cs" Inherits="Skills4Hire.Management.EditJobPost" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BackendContent" runat="server">
        ...
        var txtNumb = document.getElementById('<%= tbxContactNumb.ClientID %>');
            ...
            <div class="jobPost">
                ...
                <div class="form-group">
                    ...
                    &nbsp;<asp:TextBox ID="tbxContactNumb" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
                </div>
                ...
                <div class="form-group">
                    Publish job advert:<a class="pop-help" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-placement="top" title="Publish Job Advert" data-content="By default, 'ON' is selected to publish the advert. Select 'OFF' to unpublish advert"><span class="glyphicon glyphicon-question-sign"></span></a>
                    <br />
                ...
                <div class="btn-group">
                    ...
                    <asp:Button ID="btnPost" runat="server" Text="Save" CssClass="btn btn-success" OnClick="btnPost_Click" />
                </div>
    ...
    <script type="text/javascript">
        $(function () {
            $("#<%= cbxPublicise.ClientID %>").bootstrapSwitch();
        })
    </script>
</asp:Content>
